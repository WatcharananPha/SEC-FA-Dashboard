...
def load_and_prepare_data():
    ...
    # 1. แปลงคอลัมน์วันที่ทั้งหมดเป็น datetime object
    ...
    # 3. สร้างฟีเจอร์ใหม่ (Feature Engineering)
    # กำหนดวันที่ปัจจุบันเพื่อการคำนวณ (มีการจำลองเป็นวันที่ในอนาคต)
    today = pd.to_datetime('2025-06-16')

    # คำนวณระยะเวลาที่ใช้ไป
    ...
    # คำนวณระยะเวลาแต่ละขั้นตอนเพื่อวิเคราะห์ Bottleneck
...
# --- ส่วน Sidebar และ Filter ---
st.sidebar.header("ตัวกรองข้อมูล (Filters)")
# Dropdown ประเภทคำขอ (Req. 4)
...
# Dropdown สถานะการชำระเงิน (Req. 5)
...
# --- กราฟแสดงความคืบหน้าเทียบกับ 45 วัน (Req. 1) ---
...
with col1:
    # ตารางบริษัทที่จะต่ออายุปี 2568 (Req. 2)

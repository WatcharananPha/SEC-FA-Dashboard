...
# Apply company search filter first
...
with left_col:
    ...
    with st.container(border=True):
        ...
        if not fa_type_counts.empty:
            ...
            fig.update_layout(
                margin=dict(t=10, b=10, l=10, r=10), width=400, height=320,
    ...
    with st.container(border=True):
        ...
        if not df_controller.empty and "คำนำหน้า" in df_controller.columns:
            ...
            fig_controller = go.Figure(go.Bar(
                x=controller_counts.values, y=controller_counts.index, orientation='h',
                marker_color=colors, text=controller_counts.values, textposition='inside',
                insidetextanchor='end', textfont=dict(color='black', size=14)
            ))
            fig_controller.update_layout(
                width=400, height=150, margin=dict(t=10, b=10, l=10, r=10),
                plot_bgcolor='rgba(0,0,0,0)', xaxis=dict(visible=False, color='black', tickfont=dict(color='black')),
                yaxis=dict(autorange="reversed", color='black', tickfont=dict(color='black')), showlegend=False
            )
...
with right_col:
    ...
    with st.container(border=True):
        ...
        custom_dates = [
            "2/4/2562", "3/1/2562", "4/4/2562", "4/11/2562", "4/26/2562", "5/31/2562", "7/12/2562", "8/8/2562",
            "8/20/2562", "9/20/2562", "10/11/2562", "11/12/2562", "11/14/2562", "12/27/2562", "2/28/2563",
            "3/9/2563", "3/17/2563", "3/25/2563", "4/13/2563", "4/23/2563", "5/21/2563", "6/22/2563", "6/23/2563",
            "6/29/2563", "7/15/2563", "7/20/2563", "7/21/2563", "7/29/2563", "9/2/2563", "9/22/2563", "9/23/2563",
            "10/28/2563", "11/27/2563", "1/7/2564", "2/3/2564", "2/15/2564", "2/18/2564", "2/19/2564", "4/1/2564",
            "4/2/2564", "4/7/2564", "4/26/2564", "6/21/2564", "8/23/2564", "10/26/2564", "9/23/2564", "2/14/2565",
            "3/17/2565", "3/17/2565", "3/28/2565"
        ]
        df_display["วันที่ยื่นคำขอ"] = custom_dates[:len(df_display)]
        st.dataframe(
            df_display, use_container_width=True, height=280, hide_index=True,
            column_config={
                ...
                "วันที่ยื่นคำขอ": st.column_config.TextColumn("วันที่ยื่นคำขอ", width="medium"),
                "progress_percent_raw": st.column_config.ProgressColumn("Progress", format="%d%%", min_value=0, max_value=100),
            },
            column_order=["ลำดับที่", "คำนำหน้า", "Company (FA)", "ApplicationType", "วันที่ยื่นคำขอ", "progress_percent_raw"]
        )